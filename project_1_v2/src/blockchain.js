...
class Blockchain {
    ...
    _addBlock(block) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            // If it's not the genesis block, get the hash value of previous node.
            ...
            // Increase the chain height by one. 
            self.height += 1;
            
            if (self.chain[self.height] == block) {
                resolve(block);
            } else {
                reject(Error("Block adding faied."));
            }          
        });
    }
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (time > currentTime - 300000) {
                if(bitcoinMessage.verify(message, address, signature)) {
                    ...
                    reject(Error("Block can't verified."))
                }
            } else {
                reject(Error("Block was timed out."));
            }            
        });
    }
